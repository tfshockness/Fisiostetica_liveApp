        ...
        <form role="form" class="form-horizontal" action="/profissionais" method="POST">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="cpf" placeholder="CPF Somente numeros" name="CPF" value="{{ old('CPF') }}" required>
                        @if($errors->has('CPF'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="position" placeholder="Função"  name="position" value="{{ old('position') }}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="datepicker" placeholder="dd-mm-yyyy"  name="birth" data-date-format="dd-mm-yyyy" value="{{ old('position') }}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="email" placeholder="seu@email.com.br" name="email" value="{{ old('email') }}" required>
                    </div>
                </div>
